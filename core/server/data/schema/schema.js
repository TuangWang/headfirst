 ...
 * @Date:   2017-09-08T17:18:00+08:00
 * @Email:  wangxiaofeng@hualala.com
 * @Filename: schema.js
 * @Last modified by:   xf
 * @Last modified time: 2017-09-14T20:50:36+08:00
...
module.exports = {
 ...
 video_courses: {
   id: {type: 'string', maxlength: 24, nullable: false, primary: true},
   title: {type: 'string', maxlength: 2000, nullable: false},
   duration: {type: 'integer'}, // 秒数
   description: {type: 'text', maxlength: 100000000, fieldtype: 'long', nullable: true},
   path: {type: 'string', maxlength: 200, nullable: true}, // 课程路径
   created_at: {type: 'dateTime', nullable: false},
   created_by: {type: 'string', maxlength: 24, nullable: false},
   updated_at: {type: 'dateTime', nullable: true},
   updated_by: {type: 'string', maxlength: 24, nullable: true}
