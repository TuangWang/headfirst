...
Invite = hfBookshelf.Model.extend({
    tableName: 'invites',
    ...
    add: function add(data, options) {
        ...
        return hfBookshelf.Model.add.call(this, data, options);
    }
});

Invites = hfBookshelf.Collection.extend({
    model: Invite
});

module.exports = {
    Invite: hfBookshelf.model('Invite', Invite),
    Invites: hfBookshelf.collection('Invites', Invites)
};
