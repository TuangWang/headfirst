...
Subscriber = hfBookshelf.Model.extend({
...
Subscribers = hfBookshelf.Collection.extend({
    model: Subscriber
});

module.exports = {
    Subscriber: hfBookshelf.model('Subscriber', Subscriber),
    Subscribers: hfBookshelf.collection('Subscriber', Subscribers)
};
