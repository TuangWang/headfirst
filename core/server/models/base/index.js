...
hfBookshelf.Model = hfBookshelf.Model.extend({
  ...
  contextUser: function contextUser(options) {
    ...
    if (options.context.user || hfBookshelf.Model.isExternalUser(options.context.user)) {
      return options.context.user;
    } else if (options.context.internal) {
      return hfBookshelf.Model.internalUser;
    } else if (this.get('id')) {
      return this.get('id');
    } else if (options.context.external) {
      return hfBookshelf.Model.externalUser;
    } else {
  ...
  isInternalUser: function isInternalUser(id) {
    return id === hfBookshelf.Model.internalUser || id === hfBookshelf.Model.internalUser.toString();
  },

  isExternalUser: function isExternalUser(id) {
    return id === hfBookshelf.Model.externalUser || id === hfBookshelf.Model.externalUser.toString();
  },
   ...
   * @param {hfBookshelf.Model} Model Model type to generate a slug for
...
// Export hfBookshelf for use elsewhere
module.exports = hfBookshelf;
