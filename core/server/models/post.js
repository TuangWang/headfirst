...
Post = hfBookshelf.Model.extend({
    ...
    onSaving: function onSaving(model, attr, options) {
        ...
        hfBookshelf.Model.prototype.onSaving.call(this, model, attr, options);
        ...
        if (prevTitle !== undefined && newTitle !== prevTitle && newStatus === 'draft' && !publishedAt) {
            ops.push(function updateSlug() {
                ...
                return hfBookshelf.Model.generateSlug(Post, self.get('title'),
                    ...
                    .then(function then(slug) {
                        ...
                        return hfBookshelf.Model.generateSlug(Post, prevTitle,
                            {status: 'all', transacting: options.transacting, importing: options.importing}
            ...
            ops.push(function updateSlug() {
                ...
                if (self.hasChanged('slug') || !self.get('slug')) {
                    // Pass the new slug through the generator to strip illegal characters, detect duplicates
                    return hfBookshelf.Model.generateSlug(Post, self.get('slug') || self.get('title'),
                        {status: 'all', transacting: options.transacting, importing: options.importing})
                        .then(function then(slug) {
                            self.set({slug: slug});
                        });
    ...
    onCreating: function onCreating(model, attr, options) {
        ...
        hfBookshelf.Model.prototype.onCreating.call(this, model, attr, options);
    },
    ...
    updateTags: function updateTags(savedModel, response, options) {
        ...
        var newTags = this.tagsToSave,
            TagModel = hfBookshelf.model('Tag');
        ...
        if (options.transacting) {
            ...
            return hfBookshelf.transaction(function (t) {
    ...
    */
    ...
    filterData: function filterData(data) {
        var filteredData = hfBookshelf.Model.filterData.apply(this, arguments),
    ...
    /**
     * ### Find One
     * @extends hfBookshelf.Model.findOne to handle post status
     * **See:** [hfBookshelf.Model.findOne](base.js.html#Find%20One)
     */
    findOne: function findOne(data, options) {
        ...
        return hfBookshelf.Model.findOne.call(this, data, options).then(function then(post) {
     ...
     *
     * @extends hfBookshelf.Model.edit to handle returning the full object and manage _updatedAttributes
     * **See:** [hfBookshelf.Model.edit](base.js.html#edit)
     */
    edit: function edit(data, options) {
        var self = this,
            editPost = function editPost(data, options) {
                ...
                return hfBookshelf.Model.edit.call(self, data, options).then(function then(post) {
        ...
        return hfBookshelf.transaction(function (transacting) {
    ...
    /**
     * ### Add
     * @extends hfBookshelf.Model.add to handle returning the full object
     * **See:** [hfBookshelf.Model.add](base.js.html#add)
     */
    add: function add(data, options) {
        var self = this;
        options = options || {};

        return hfBookshelf.Model.add.call(this, data, options).then(function then(post) {
...
Posts = hfBookshelf.Collection.extend({
    model: Post
});

module.exports = {
    Post: hfBookshelf.model('Post', Post),
    Posts: hfBookshelf.collection('Posts', Posts)
};
