...
HFLogger.prototype.setStdoutStream = function () {
...
HFLogger.prototype.setLogglyStream = function () {
 ...
 */
HFLogger.prototype.setFileStream = function () {
...
HFLogger.prototype.setSerializers = function setSerializers() {
    var self = this;
...
HFLogger.prototype.removeSensitiveData = function removeSensitiveData(obj) {
    var newObj = {};
 ...
 */
HFLogger.prototype.log = function log(type, args) {
    var self = this,
        modifiedArguments;
...
HFLogger.prototype.info = function info() {
    this.log('info', arguments);
};

HFLogger.prototype.warn = function warn() {
    this.log('warn', arguments);
};

HFLogger.prototype.error = function error() {
    this.log('error', arguments);
};

module.exports = HFLogger;
